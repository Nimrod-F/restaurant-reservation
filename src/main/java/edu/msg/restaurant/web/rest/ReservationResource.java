...
import edu.msg.restaurant.service.ReservationQueryService;
...
/**
 * REST controller for managing {@link edu.msg.restaurant.domain.Reservation}.
 */
@RestController
@RequestMapping("/api")
public class ReservationResource {
    ...
    public ResponseEntity<List<ReservationDTO>> getAllReservations(ReservationCriteria criteria) {
        log.debug("REST request to get Reservations by criteria: {}", criteria);
        List<ReservationDTO> entityList = reservationQueryService.findByCriteria(criteria);
